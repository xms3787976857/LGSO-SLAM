...
GaussianPipelineParams::GaussianPipelineParams(bool convert_SHs, bool compute_cov3D, float depth_ratio)
    : convert_SHs_(convert_SHs), compute_cov3D_(compute_cov3D), depth_ratio_(depth_ratio)
{}
