...
float setting_kfGlobalWeight = 1.0;   // general weight on threshold, the larger the more KF's are taken (e.g., 2 = double the amount of KF's).
float setting_maxAffineWeight= 2;	// 2, 0.5
...
double setting_solverModeDelta = 0.00001;	// 0.00001
...
int   setting_maxOptIterations=6; // max GN iterations. default: 6
int   setting_minOptIterations=1; // min GN iterations. default: 1
