...
namespace dso {
    ...
    **/
    ...
    public:
        ...
        EdgePRIDP(double x, double y, std::shared_ptr<CalibHessian> &calib) : BaseMultiEdge<2, Vec2>() {
            resize(3);
            this->x = x;
            this->y = y;
            cam = calib;
    ...
    public:
        ...
        EdgeProjectPoseOnly(double fx, double fy, double cx, double cy, const Vector3d &pw_)
    ...
    public:
        ...
        EdgeProjectPoseOnlySim3(double fx, double fy, double cx, double cy, const Vector3d &pw_)
