#pragma once
#ifndef LGSO_LOOP_CLOSING_H_
#define LGSO_LOOP_CLOSING_H_
...
namespace dso {
    ...
    public:
        ...
        typedef pair<set<std::shared_ptr<Frame>>, int> ConsistentGroup;
    ...
    private:
         ...
         */
        bool
        ComputeOptimizedPose(std::shared_ptr<Frame> pKF, Sim3 &Scr, CalibHessian* Hcalib, Mat77 &hessian,
        ...
        // std::shared_ptr<KeyFrameDatabase> kfDB = nullptr;
