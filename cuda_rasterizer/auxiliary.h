...
// __device__ const float FilterSize = 0.47140452; // sqrt(2) / 3
// __device__ const float FilterInvSquare = 4.5f;
// __device__ const float FilterSize = 0.942809; // sqrt(2) / 3*2
// __device__ const float FilterInvSquare = 1.125f;
...
quat_to_rotmat(const glm::vec4 quat) {
